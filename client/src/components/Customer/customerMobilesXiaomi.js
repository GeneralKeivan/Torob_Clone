...
var first;
var found = false;
class CustomerMobileXiaomi extends Component {
    ...
    handleUpdate(event) {
        ...
        for(var i = 0; i < products.length; i++){
            if(String(products[i].name.toLowerCase().includes(searchBar)) && products[i].brand === "xiaomi" && products[i].model === "mobile"){
    ...
    render() {
      ...
      if(first){
        ...
        for(var i = 0; i < products.length; i++){
            if(products[i].model === "mobile" && products[i].brand === "xiaomi"){
        ...
        return (
            <div>
                ...
                <div className="row">
                    ...
                    {
                        !found === 0 ? productMobile : (sortType === "low" ? productLowHigh : (sortType ==="high" ? productHighLow : (sortType === "recent" ? productRecent : productList)))
                    }
                    </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerMobileXiaomi);