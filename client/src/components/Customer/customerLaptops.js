...
var first;
var found = false;
class CustomerLaptops extends Component {
    ...
    handleUpdate(event) {
        ...
        for(var i = 0; i < products.length; i++){
            if((String(products[i].name).toLowerCase().includes(searchBar) || String(products[i].brand).toLowerCase().includes(searchBar)) && products[i].model === "laptop"){
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerLaptops);