...
class CustomerTabletXiaomi extends Component {
    ...
    handleUpdate(event) {
        ...
        for(var i = 0; i < products.length; i++){
            if(String(products[i].name.toLowerCase().includes(searchBar)) && products[i].brand === "xiaomi" && products[i].model === "tablet"){
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerTabletXiaomi);