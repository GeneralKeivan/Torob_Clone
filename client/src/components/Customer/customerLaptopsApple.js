...
class CustomerLaptopApple extends Component {
    ...
    handleUpdate(event) {
        ...
        for(var i = 0; i < products.length; i++){
            if(String(products[i].name).toLowerCase().includes(searchBar) && products[i].brand === "apple" && products[i].model === "laptop"){
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerLaptopApple);