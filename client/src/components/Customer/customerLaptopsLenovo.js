...
var sortType = "none"
class CustomerLaptopLenovo extends Component {
    ...
    componentDidMount() {
        ...
        for(var i = 0; i < products.length; i++){
            if(products[i].model === "laptop" && products[i].brand === "lenovo"){
    ...
    handleUpdate(event) {
        ...
        for(var i = 0; i < products.length; i++){
            if(products[i].name.inludes(searchBar) && products[i].brand === "lenovo" && products[i].model === "laptop"){
        ...
        return (
            <div>
                <div>
                    ...
                    <Link to={url + '/accounts/'} ><button className="btn btn-primary pull-left" >Sign Out</button></Link>
                </div>
                <div>
...
export default (CustomerLaptopLenovo)